...
export class Asset implements MoneyPool {
    ...
    static create(name: string, startYear: number, initialValue: number, intrinsicGrowthRate: number, extrapolateFromZero: boolean): Asset {
        return new Asset(name, startYear, initialValue, intrinsicGrowthRate, extrapolateFromZero);
    }
